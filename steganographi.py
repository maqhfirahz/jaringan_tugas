...
class SteganographyApp:
    def __init__(self, root):
        ...
        self.create_gradient("#e0bbff", "#ffffff")  # Gradient dari lilac ke putih

        # Gaya elemen GUI
        style = ttk.Style()
        style.configure("TLabel", background="#e0bbff", foreground="black", font=("Arial", 14))
        style.configure("TButton", font=("Arial", 12, "bold"), padding=5, foreground="black")
        style.map("TButton", background=[("active", "#d8a3ff"), ("!active", "#bf80ff")])

        # Header
        self.title_label = ttk.Label(
            self.root, text="Steganography Tool", font=("Arial", 24, "bold"), background="#e0bbff"
        )
    ...
    def on_resize(self, event):
        ...
        self.create_gradient("#e0bbff", "#ffffff")  # Perbarui gradient
        self.title_label.place(relx=0.5, y=30, anchor="center")
        self.hide_button.place(relx=0.5, rely=0.3, anchor="center")
        self.reveal_button.place(relx=0.5, rely=0.45, anchor="center")
        self.exit_button.place(relx=0.5, rely=0.6, anchor="center")
