...
window.config(bg="#D1C4E9")  # Background Light Lavender (Ungu muda)

# Membuat elemen GUI
frame = tk.Frame(window, bg="#E1BEE7")  # Background Light Purple
frame.pack(padx=10, pady=10)

# Label dan entry untuk posisi rotor
rotor1_pos_label = tk.Label(frame, text="Posisi Rotor 1:", fg="white", bg="#E1BEE7", font=("Helvetica", 12))
...
rotor2_pos_label = tk.Label(frame, text="Posisi Rotor 2:", fg="white", bg="#E1BEE7", font=("Helvetica", 12))
...
rotor3_pos_label = tk.Label(frame, text="Posisi Rotor 3:", fg="white", bg="#E1BEE7", font=("Helvetica", 12))
...
text_input_label = tk.Label(frame, text="Masukkan Teks:", fg="white", bg="#E1BEE7", font=("Helvetica", 12))
...
encrypt_button = tk.Button(frame, text="Enkripsi", command=enkripsi, bg="#9C27B0", fg="white", font=("Helvetica", 12), relief="solid", bd=3)
encrypt_button.grid(row=4, column=0, padx=5, pady=5)

decrypt_button = tk.Button(frame, text="Dekripsi", command=dekripsi, bg="#673AB7", fg="white", font=("Helvetica", 12), relief="solid", bd=3)
decrypt_button.grid(row=4, column=1, padx=5, pady=5)

# Efek hover pada tombol
def on_enter(event):
    event.widget.config(bg="#8E24AA")
...
text_output_label = tk.Label(frame, text="Hasil:", fg="white", bg="#E1BEE7", font=("Helvetica", 12))
